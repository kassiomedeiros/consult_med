...
public class PacienteDAO {
	...
	public Paciente buscaPorNome(String nome) {
		this.factory.getTransaction().begin();
		Query query = this.factory.createQuery("SELECT p FROM Paciente p WHERE p.nome = :nome");
	...
	public Paciente buscaPorEmail(String email) {
		this.factory.getTransaction().begin();
		Query query = this.factory.createQuery("SELECT p FROM Paciente p WHERE p.email = :email");
